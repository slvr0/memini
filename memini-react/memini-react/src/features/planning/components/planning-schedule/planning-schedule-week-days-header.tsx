...
interface PlanningScheduleWeekDaysHeaderProps {
    week : number;
    weekdays: ICalendarDate[]; //weekdays of selection
}

const PlanningScheduleWeekDaysHeader : React.FC<PlanningScheduleWeekDaysHeaderProps> = (props) => {
...
export default PlanningScheduleWeekDaysHeader;