...
interface PlanningManagementContainerProps {

}

const PlanningManagementContainer: React.FC<PlanningManagementContainerProps> = (props) => {
    return (
    <div className="">
...
export default PlanningManagementContainer;