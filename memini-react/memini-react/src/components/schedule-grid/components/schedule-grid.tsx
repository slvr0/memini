...
import { setupClockMarkers } from "../computation/computations";
import { useTaskManager } from "../../task/utils/task-manager";
import store, { RootState } from "../../../store/index";
import {calendarDateActions} from "../../../store/user-calendar-store";

import { tasksSelectors, makeSelectTasksByDate, isDateLoaded } from "../../task/store/task-selector";
import { toDateKey } from "../../task/utils/date-utils"
import type { DateKey, Task } from "../../task/store/task-types";
...
const ScheduleGrid: React.FC = () => {
  ...
  const __areDisplayTasksLoaded = areDisplayTasksLoaded(selectedDate.year, selectedDate.month, selectedDate.day);
  const dateKey = toDateKey(selectedDate.year, selectedDate.month, selectedDate.day);
  //const displayTasks = getTasksFromSelector(dateKey);
